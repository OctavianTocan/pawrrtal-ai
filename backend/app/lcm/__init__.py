...
# ``from app.lcm import schedule_lcm_compaction`` without reaching
# into ``app.lcm.background``. The import sits at the bottom of the
# module so ``background.py``'s own ``from app.lcm import
# compact_leaf_if_needed`` succeeds (that symbol is defined above).
from app.lcm.background import schedule_lcm_compaction  # noqa: E402
