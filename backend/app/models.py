...
# ---------------------------------------------------------------------------
# LCM retrieval substrate (PR #258)
#
# Implementations live in :mod:`app.lcm_models` to keep this file under
# the project's 500-line budget. Re-exported here so existing imports
# (``from app.models import LCMSummary``) keep working.
# ---------------------------------------------------------------------------
...
from .lcm_models import (  # noqa: E402
    LCMContextItem,
    LCMEmbedding,
    LCMSummary,
    LCMSummarySource,
