...
OPENCODE_GO_ENTRIES: tuple[ModelEntry, ...] = (
    ...
    ModelEntry(
        ...
        description="Moonshot's newest code-focused Kimi model",
    ),
    ModelEntry(
        host=Host.opencode_go,
        vendor=Vendor.moonshot,
    ...
    ModelEntry(
        ...
        description="Xiaomi's previous MiMo Pro model",
    ),
    ModelEntry(
        host=Host.opencode_go,
        vendor=Vendor.xiaomi,
        ...
        description="Xiaomi's multimodal MiMo V2 model",
    ),
    ModelEntry(
        host=Host.opencode_go,
        ...
        description="Alibaba's latest Qwen Plus model",
    ),
    ModelEntry(
        host=Host.opencode_go,
        vendor=Vendor.alibaba,
        ...
        description="Alibaba's latest Qwen Max model",
    ),
    ModelEntry(
        host=Host.opencode_go,
        vendor=Vendor.alibaba,
    ...
    ModelEntry(
        ...
        description="MiniMax's newest frontier model",
    ),
    ModelEntry(
        host=Host.opencode_go,
        vendor=Vendor.minimax,
