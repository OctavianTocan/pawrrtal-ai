 ...
 */
function useSelectedChatModel(initialModelId: string | null | undefined): UseSelectedChatModelResult {
  const {
    models,
 ...
 */
function useChatActivitySync(conversationId: string, chatHistory: Array<ChatMessage>, isLoading: boolean): void {
