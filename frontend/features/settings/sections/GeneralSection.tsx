...
export function GeneralSection(): React.JSX.Element {
  ...
  return (
    <SettingsPage description="Profile, preferences, and notifications for your account." title="General">
      ...
      <SettingsCard>
        <SettingsSectionHeader description="System-level alerts Pawrrtal can surface to you." title="Notifications" />
        <SettingsRow
