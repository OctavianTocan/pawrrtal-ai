...
export const COLOR_SLOTS = ['background', 'foreground', 'accent', 'info', 'success', 'destructive'] as const;
...
export const DEFAULT_FONTS: Record<FontSlot, string> = {
  display: 'var(--font-display-loaded, "Newsreader"), "Iowan Old Style", "Charter", Georgia, "Times New Roman", serif',
...
export const THEME_PRESETS: ReadonlyArray<MockThemePreset> = [
  {
    id: 'pawrrtal',
    name: 'Pawrrtal',
    description: 'Warm off-white canvas, soft purple accent, soft blue info, forest green success.',
