...
describe('OnboardingCreateWorkspaceStep', () => {
  it('renders the workspace selection options', () => {
    const { container } = render(wrap(<OnboardingCreateWorkspaceStep onPickLocal={() => undefined} />));
  ...
  it('disables only the upcoming Create new option, leaving Open folder enabled', () => {
    const { container, getByText } = render(wrap(<OnboardingCreateWorkspaceStep onPickLocal={() => undefined} />));
  ...
  it('fires onPickLocal when the enabled "Open folder" button is clicked', async () => {
    ...
    const { getByText } = render(wrap(<OnboardingCreateWorkspaceStep onPickLocal={onPickLocal} />));
