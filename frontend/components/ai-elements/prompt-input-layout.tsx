 ...
 */
function PromptInputActionMenuTriggerSlot({ children }: { children: ReactNode }): React.JSX.Element {
  return <>{children}</>;
}
PromptInputActionMenuTriggerSlot.displayName = 'PromptInputActionMenuTriggerSlot';

function PromptInputActionMenuContentSlot({ children }: { children: ReactNode }): React.JSX.Element {
  return <>{children}</>;
}
 ...
 * working unchanged.
 */
const _PromptInputActionMenu = ({ children, className, onOpenChange }: PromptInputActionMenuProps) => {
...
const _PromptInputActionMenuTrigger = ({ className, children, ...props }: PromptInputActionMenuTriggerProps) => (
...
const _PromptInputTab = ({ className, ...props }: PromptInputTabProps) => <div className={cn(className)} {...props} />;
...
const _PromptInputTabLabel = ({ children = 'Prompt input options', className, ...props }: PromptInputTabLabelProps) => (
...
const _PromptInputCommandSeparator = ({ className, ...props }: PromptInputCommandSeparatorProps) => (
