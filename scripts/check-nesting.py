...
EXEMPT_FUNCTIONS: frozenset[str] = frozenset(
    {
        ...
        "backend/app/channels/telegram/channel.py::deliver",
        ...
        "backend/app/providers/litellm_provider.py::_build_litellm_messages",
        "backend/app/providers/opencode_go/events.py::build_openai_messages",
        "backend/app/providers/xai/messages.py::build_xai_messages",
        "backend/app/channels/telegram/finalize.py::finalize_turn_delivery",
        ...
        "backend/app/providers/gemini/messages.py::_user_parts",
        "backend/app/providers/openai_codex/inputs.py::build_codex_run_input",
        "backend/app/providers/openai_codex/provider.py::stream",
        "backend/app/agents/scheduling/scheduler.py::_hydrate_active_jobs",
