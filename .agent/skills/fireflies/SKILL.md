...
- [ ] Run `python3 .agent/skills/fireflies/scripts/fireflies_cli.py list --limit 5` to get the list of recent meetings.
...
- [ ] Run `python3 .agent/skills/fireflies/scripts/fireflies_cli.py search "<topic>"` to find relevant meetings.
- [ ] For the most relevant matches, run `python3 .agent/skills/fireflies/scripts/fireflies_cli.py get "<id>"` to fetch the overview and action items.
