...
| Runner operations | `runner-ops` skill | Start, stop, lock, clean, or inspect self-hosted GitHub Actions runners. |
...
7. After touching self-hosted runners for CI or verification, use `runner-ops` and prove runner location, labels, processes, services, and disk state.
