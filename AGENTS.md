...
- When walking through new or unfamiliar stacks (for example Effect backend migration), prefer ultra-granular, plain-language step-by-step explanations over dense summaries.
